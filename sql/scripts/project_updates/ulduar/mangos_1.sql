...
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES (800012, 32933, 603, 3, 65535, 0, 0, 1799.68, -24.3599, 452.227, 3.14747, 604800, 0, 0, 543855, 0, 0, 0);
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES (800013, 32934, 603, 3, 65535, 0, 0, 1799.68, -24.3599, 452.227, 3.14747, 604800, 0, 0, 543855, 0, 0, 0);
...
UPDATE `creature_template` SET `modelid_A` = 15880, `modelid_H` = 15880 WHERE `entry` = 33174;
UPDATE `creature_template` SET `modelid_A2` = 28470, `modelid_H2` = 28470, ScriptName = "mob_icicle" WHERE `entry` = 33169;
-- flash freeze that will lock the npcs in iceblock
UPDATE creature_template SET `modelid_A` = 25865, `modelid_H` = 25865, ScriptName = "mob_npc_flashFreeze" WHERE entry in (32938, 33353);
...
UPDATE gameobject_template SET flags= 32, ScriptName="go_celestial_acces" WHERE entry in (194628, 194752);
