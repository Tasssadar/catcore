...
extern void AddSC_boss_drakkari_colossus();                 //gundrak
...
extern void AddSC_instance_violethold();                   //violet hold
...
void AddScripts()
{
    ...
    AddSC_boss_drakkari_colossus();                         //gundrak
...
//    AddSC_boss_thaddius(); not scripted yet
    ...
    AddSC_boss_koralon();
    AddSC_instance_violethold();                            //violet_hold
    AddSC_violet_hold();
