...
enum
{
    ...
    ACHI_MORE_DOTS_10           = 4402,
    ACHI_MORE_DOTS_25           = 4405,
            ...
            case PHASE_BREATH:
            {
                ...
                if (m_bIsSummoningWhelps)
                {
                    if (m_uiSummonCount < MAX_WHELPS_PER_PACK)
                    {
                        ...
                        {
                            m_creature->SummonCreature(NPC_WHELP, afSpawnLocations[0][0], afSpawnLocations[0][1], afSpawnLocations[0][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
                            m_creature->SummonCreature(NPC_WHELP, afSpawnLocations[1][0], afSpawnLocations[1][1], afSpawnLocations[1][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
                            m_uiWhelpTimer = 500;
                        }
                        else
                ...
                if (m_uiSummonGuardTimer < uiDiff)
                {
                    ...
                    {
                        m_creature->SummonCreature(NPC_LAIR_GUARD, afSpawnLocations[2][0], afSpawnLocations[2][1], afSpawnLocations[2][2], 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
