...
#define GOSSIP_ITEM_CHROMI4 "Teleport me to Arthas, please."
...
bool GossipHello_npc_chromi_start(Player* pPlayer, Creature* pCreature)
{
    ...
    {
        if (pPlayer->GetQuestStatus(QUEST_DISPELLING_ILLUSIONS) == QUEST_STATUS_COMPLETE && pPlayer->GetQuestStatus(QUEST_A_ROYAL_ESCORT) != QUEST_STATUS_COMPLETE && pInstance->GetData(TYPE_QUEST) == NOT_STARTED)
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_ITEM_CHROMI1, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);

        else if (pPlayer->GetQuestStatus(QUEST_DISPELLING_ILLUSIONS) == QUEST_STATUS_COMPLETE)
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_ITEM_CHROMI4, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+4);
    }
...
bool GossipSelect_npc_chromi_start(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    ...
    if (uiAction == GOSSIP_ACTION_INFO_DEF+4) 
    {
        if (ScriptedInstance* pInstance = (ScriptedInstance*)pCreature->GetInstanceData())
        {
            pInstance->SetData(TYPE_QUEST, DONE);

            if (pPlayer)
                pPlayer->TeleportTo(595,1811.350f,1283.445f,143.324f,0.899f,0);
        }
    }
...
{
   SAY_MIKE01                = -1595270,
   SAY_FORRESTER02           = -1595271,
   SAY_JAMES03               = -1595272,
   SAY_SIABI04               = -1595273,
   SAY_MIKE05                = -1595274,
   SAY_CORICKS06             = -1595275,
   SAY_GRIAN07               = -1595276,
   SAY_CORICKS08             = -1595277,
   SAY_JAMES09               = -1595278,
   SAY_FORRESTER10           = -1595279,
...
enum
{
  SAY_MORIGAN01                     = -1595284,
  SAY_PERELLI02                     = -1595285,
  SAY_MORIGAN03                     = -1595286,
  SAY_PERELLI04                     = -1595287,
  SAY_MORIGAN05                     = -1595288,
  SAY_PERELLI06                     = -1595289,
  SAY_MORIGAN07                     = -1595290,
};
...
{
  SAY_JENA01           = -1595291,
  SAY_MARTHA02         = -1595292,
  SAY_JENA03           = -1595293,
  SAY_JENA04           = -1595294,
  SAY_MARTHA05         = -1595295,
...
enum
{
  ...
  SAY_MALCOLM01         = -1595296,
  SAY_MALCOLM02         = -1595297,
  SAY_MALCOLM03         = -1595298,
  SAY_MALCOLM04         = -1595299,
};
...
enum
{
  SAY_BARTLEBY01         = -1595300,
  SAY_BARTLEBY02         = -1595301, 
  SAY_BARTLEBY03         = -1595302,
  SAY_BARTLEBY04         = -1595303,
  SAY_BARTLEBY05         = -1595304,
};
