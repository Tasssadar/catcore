...
enum
{
    SAY_MALGANIS_AGGRO       = -1595170,
    SAY_MALGANIS_SLAY01      = -1595172,
    SAY_MALGANIS_SLAY02      = -1595173,
    SAY_MALGANIS_SLAY03      = -1595174,
    SAY_MALGANIS_SLAY04      = -1595175,
    SAY_MALGANIS_SLAY05      = -1595176,
    SAY_MALGANIS_SLAY06      = -1595177,
    SAY_MALGANIS_SLAY07      = -1595166,
    SAY_MALGANIS_SLEEP01     = -1595185,
    SAY_MALGANIS_SLEEP02     = -1595186,
    SAY_MALGANIS_Sleep       = -1595178,
    SAY_MALGANIS_15HP        = -1595179,
...
struct MANGOS_DLL_DECL boss_malganisAI : public ScriptedAI
{
  ...
  uint32 Vampire_Timer;
   ...
   void KillCreditMalganis()
   {
         ...
         {
           // Lfg expansion
           Group *group = players.begin()->getSource()->GetGroup();
           if (group && group->isLfgGroup())
               ((LfgGroup*)group)->KilledCreature(m_creature);
