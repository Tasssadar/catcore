...
enum
{
    SAY_INTRO01                           = -1595071,    //Arthas
    SAY_INTRO02                           = -1595072,    //Uther
    SAY_INTRO03                           = -1595073,    //Arthas
    SAY_INTRO04                           = -1595074,    //Arthas
    SAY_INTRO05                           = -1595075,    //Uther
    SAY_INTRO06                           = -1595076,    //Arthas
    SAY_INTRO07                           = -1595077,    //Uther
    SAY_INTRO08                           = -1595078,    //Arthas
    SAY_INTRO09                           = -1595079,    //Arthas
    SAY_INTRO10                           = -1595080,    //Uther
    SAY_INTRO11                           = -1595081,    //Arthas
    SAY_INTRO12                           = -1595082,    //Uther
    SAY_INTRO13                           = -1595083,    //Jaina
    SAY_INTRO14                           = -1595084,    //Arthas
    SAY_INTRO15                           = -1595085,    //Uther
    SAY_INTRO16                           = -1595086,    //Arthas
    SAY_INTRO17                           = -1595087,    //Jaina
    SAY_INTRO18                           = -1595088,    //Arthas

    SAY_ENTER01                           = -1595089,    //Arthas
    SAY_ENTER02                           = -1595090,    //Cityman
    SAY_ENTER03                           = -1595091,    //Arthas
    SAY_ENTER04                           = -1595092,    //Crazyman
    SAY_ENTER05                           = -1595093,    //Crazyman2
    SAY_ENTER06                           = -1595094,    //Arthas
    SAY_ENTER07                           = -1595095,    //Malganis
    SAY_ENTER08                           = -1595096,    //Malganis
    SAY_ENTER09                           = -1595097,    //Arthas
    SAY_ENTER10                           = -1595098,    //Arthas

    SAY_SALRAMM_SPAWN                     = -1595129,
    SAY_MEATHOOK_SPAWN                    = -1595110,

    SAY_PHASE501                          = -1595142,    //Arthas
    SAY_PHASE502                          = -1595143,    //Arthas
    SAY_PHASE503                          = -1595144,    //Human
    SAY_PHASE504                          = -1595145,    //Arthas
    SAY_PHASE505                          = -1595146,    //Arthas
    SAY_PHASE506                          = -1595147,    //Human
    SAY_PHASE507                          = -1595148,    //Arthas
    SAY_PHASE508                          = -1595149,    //Arthas
    SAY_PHASE509                          = -1595150,    //Arthas
    SAY_PHASE510                          = -1595151,    //Arthas
    SAY_PHASE511                          = -1595152,    //Arthas
    SAY_PHASE512                          = -1595153,    //Arthas
    SAY_PHASE513                          = -1595154,    //Arthas

    SAY_EPOCH_INTRO                       = -1595155,
    SAY_ARTHAS_INTRO                      = -1595156,
    SAY_EPOCH_AGGRO                       = -1595157,

    SAY_PHASE514                        = -1595158,   //Arthas Shkaf 01
    SAY_PHASE515                        = -1595159,   //Arthas Shkaf 02
    SAY_PHASE601                        = -1595160,  //Arthas Fire
    SAY_PHASE602                        = -1595161,  //Arthas Picnic
    SAY_PHASE603                        = -1595162,  //Arthas Picnic End
    SAY_PHASE605                        = -1595164,  //Arthas mall start
    SAY_PHASE606                        = -1595188,

    SAY_MALGANIS_ESCAPE02    = -1595180, 
    SAY_MALGANIS_ESCAPE01    = -1595187, 
    SAY_MALGANIS_OUTRO       = -1595182,
    SAY_ARTHAS_OUTRO01       = -1595181,
    SAY_ARTHAS_OUTRO02       = -1595183,
    SAY_ARTHAS_OUTRO03       = -1595184,
...
struct MANGOS_DLL_DECL npc_arthasAI : public npc_escortAI
{
    ...
    {
        m_pInstance->SetData(TYPE_RESTART, 1);
        float x, y, z, o;
        m_creature->GetRespawnCoord(x,y,z,&o);
        m_creature->SummonCreature(m_creature->GetEntry(), x,y,z,o, TEMPSUMMON_MANUAL_DESPAWN, 0);
    ...
    void SummonWing()
    {
        ...
        switch(m_uiWaveCount)
        {
           ...
           case 5:
              ...
              if(Creature* pMeathook = m_creature->SummonCreature(NPC_MEATHOOK,2130.495f, 1361.177f, 132.735f, 5.868f,TEMPSUMMON_CORPSE_TIMED_DESPAWN,29000))
              {
                 DoScriptText(SAY_MEATHOOK_SPAWN, pMeathook);
                 pMeathook->RemoveSplineFlag(SPLINEFLAG_WALKMODE);
                 pMeathook->GetMotionMaster()->MovePoint(0, 2170.873f, 1344.379f, 131.091f);
              }
              break;
           case 6:
              m_pInstance->SetData(TYPE_WING, LEFT);
           ...
           case 10:
              ...
              if(Creature* pSalramm = m_creature->SummonCreature(NPC_SALRAMM,2196.036f, 1328.818f, 129.997f, 3.12f,TEMPSUMMON_CORPSE_TIMED_DESPAWN,29000))
              {
                 ...
                 pSalramm->GetMotionMaster()->MovePoint(0, 2196.036f, 1328.818f, 131.997f);
              }
              break;
        }
    }
...
bool GossipHello_npc_chromi_middle(Player* pPlayer, Creature* pCreature)
{
    ...
    if(pInstance && pInstance->GetData(TYPE_INTRO) == NOT_STARTED && (pInstance->GetData(TYPE_QUEST) == DONE || pPlayer->GetQuestStatus(QUEST_DISPELLING_ILLUSIONS) == QUEST_STATUS_COMPLETE))
...
/*enum
{
   SAY_PEOPLE01         = -1595099,
   SAY_PEOPLE02         = -1595100,
   SAY_PEOPLE03         = -1595101,
   SAY_PEOPLE04         = -1595102,
   SAY_PEOPLE05         = -1595103,
};*/
