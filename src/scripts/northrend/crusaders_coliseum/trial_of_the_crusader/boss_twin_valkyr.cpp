...
struct MANGOS_DLL_DECL boss_twin_valkyrAI : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        AddTimer(TIMER_SHIELD, isLight ? SPELL_SHIELD_OF_LIGHTS : SPELL_SHIELD_OF_DARKNESS, RV(40000,50000), RV(40000,50000), UNIT_SELECT_SELF);
        ...
        AddTimer(TIMER_VORTEX, isLight ? SPELL_LIGHT_VORTEX : SPELL_DARK_VORTEX, RV(40000,50000),RV(40000,50000), UNIT_SELECT_SELF);
        AddTimer(TIMER_CONCENTRATED, 0, RV(15000,20000), RV(40000,50000), UNIT_SELECT_NONE, CAST_TYPE_IGNORE);
        if (isHeroic)
