...
struct MANGOS_DLL_DECL boss_moorabiAI : public ScriptedAI
{
    ...
    bool Phase;
    bool m_isHeroic;
    /* uint32 SPELL_QUAKE_TIMER; NOT USED */
     ...
     void JustDied(Unit *killer)
     {
        ...
        if (m_isHeroic && Phase == false)
        {
            ...
            if (AchievLessRabi)
            {
                ...
                if (pInstance)
                {
                    pInstance->CompleteAchievement(ACHIEVEMENT_LESS_RABI, (Player*)killer, true);
                }
            }
        }        
    ...
    void KilledUnit(Unit *victim)
    {
        ...
        DoScriptText(urand(0, 1) ? SAY_SLAY_2 : SAY_SLAY_3, m_creature);
    }
};
