...
class Spell
{
    ...
    public:
        ...
        void EffectSummonWild(SpellEffectEntry const* effect, uint32 forceFaction = 0);
        void EffectSummonGuardian(SpellEffectEntry const* effect, uint32 forceFaction = 0);
        void EffectHealMechanical(SpellEffectEntry const* effect);
        void EffectJump(SpellEffectEntry const* effect);
        void EffectJumpToDest(SpellEffectEntry const* effect);
        ...
        void EffectSummonCritter(SpellEffectEntry const* effect, uint32 forceFaction = 0);
        ...
        void EffectQuestStart(SpellEffectEntry const* effectx);
        void EffectActivateRune(SpellEffectEntry const* effect);
        void EffectWMODamage(SpellEffectEntry const* effectx);
        void EffectWMORepair(SpellEffectEntry const* effectx);
        ...
        void EffectBind(SpellEffectEntry const* effectx);
        void EffectRestoreItemCharges(SpellEffectEntry const* effectx);
        void EffectRemoveAura(SpellEffectEntry const* effectx);
        void EffectTeachTaxiNode(SpellEffectEntry const* effectx);
        void EffectBreakPlayerTargeting(SpellEffectEntry const* effectx);
        void EffectRedirectThreat(SpellEffectEntry const* effectx);
