...
#define SPELL_ATTR_EX2_NOT_NEED_SHAPESHIFT        0x00080000            // 19 does not necessarly need shapeshift <-- wrong
...
enum TalentSpec
{
    TALENT_SPEC_NO_SPEC             = 0,
    TALENT_SPEC_MAGE_FIRE           = 41,   // mage
    TALENT_SPEC_MAGE_FROST          = 61,
    TALENT_SPEC_MAGE_ARCANE         = 81,
    TALENT_SPEC_WARRIOR_ARMS        = 161,  // warrior
    TALENT_SPEC_WARRIOR_PROTECTION  = 163,
    TALENT_SPEC_WARRIOR_FURY        = 164,
    TALENT_SPEC_ROGUE_COMBAT        = 181,  // rogue
    TALENT_SPEC_ROGUE_ASSASSINATION = 182,
    TALENT_SPEC_ROGUE_SUBTLETY      = 183,
    TALENT_SPEC_PRIEST_DISCIPLINE   = 201,  // priest
    TALENT_SPEC_PRIEST_HOLY         = 202,
    TALENT_SPEC_PRIEST_SHADOW       = 203,
    TALENT_SPEC_SHAMAN_ELEMENTAL    = 261,  // shaman
    TALENT_SPEC_SHAMAN_RESTORATION  = 262,
    TALENT_SPEC_SHAMAN_ENHANCEMENT  = 263,
    TALENT_SPEC_DRUID_FERAL_COMBAT  = 281,  // druid
    TALENT_SPEC_DRUID_RESTORATION   = 282,
    TALENT_SPEC_DRUID_BALANCE       = 283,
    TALENT_SPEC_WARLOCK_DESTRUCTION = 301,  // warlock
    TALENT_SPEC_WARLOCK_AFFLICTION  = 302,
    TALENT_SPEC_WARLOCK_DEMONTOLOGY = 303,
    TALENT_SPEC_HUNTER_BEAST_MASTERY= 361,  // hunter
    TALENT_SPEC_HUNTER_SURVIVAL     = 362,
    TALENT_SPEC_HUNTER_MARKSMANSHIP = 363,
    TALENT_SPEC_PALADIN_RETRIBUTION = 381,  // paladin
    TALENT_SPEC_PALADIN_HOLY        = 382,
    TALENT_SPEC_PALADIN_PROTECTION  = 383,
    TALENT_SPEC_DEATH_KNIGHT_BLOOD  = 398,  // dk
    TALENT_SPEC_DEATH_KNIGHT_FROST  = 399,
    TALENT_SPEC_DEATH_KNIGHT_UNHOLY = 400,
    TALENT_SPEC_PET_TENACITY        = 409,  // hunter's pet
    TALENT_SPEC_PET_FEROCITY        = 410,
    TALENT_SPEC_PET_CUNNING         = 411
};
