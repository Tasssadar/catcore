...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_INSTANCE_RESET_CONSTANT,
    ...
    CONFIG_UINT32_TEAM_BG_MIN_LEVEL,
    ...
    CONFIG_UINT32_LFG_MIXED_MINLEVEL,
    CONFIG_UINT32_LFG_MIXED_MAXLEVEL,
    CONFIG_UINT32_CREATURE_GUID_MIN,
    CONFIG_UINT32_START_INCREASE_MAX_RATING_TIMER,
    CONFIG_UINT32_STEP_INTERVAL,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_START_MAX_CHANCE_DIFFERENCE,
    CONFIG_FLOAT_STEP_ADD_CHANCE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_CREATURE_GUID_ENABLED,
    CONFIG_BOOL_CREATURE_GUID_CHANGE,
    CONFIG_BOOL_GO_GUID_ENABLED,
    CONFIG_BOOL_GO_GUID_CHANGE,
