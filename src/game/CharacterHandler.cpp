...
bool LoginQueryHolder::Initialize()
{
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADBOUNDINSTANCES,  "SELECT instance FROM character_instance WHERE guid = '%u'", GUID_LOPART(m_guid));
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADQUESTSTATUS,     "SELECT quest,status,explored,timer,mobcount1,mobcount2,mobcount3,mobcount4,itemcount1,itemcount2,itemcount3,itemcount4 FROM character_queststatus WHERE guid = '%u'", GUID_LOPART(m_guid));
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADREWARDEDQUESTSTATUS, "SELECT quest FROM character_queststatus_rewarded WHERE guid = '%u'", GUID_LOPART(m_guid));
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADINVENTORY,       "SELECT bag,slot,item,item_template FROM character_inventory WHERE character_inventory.guid = '%u' ORDER BY bag,slot", GUID_LOPART(m_guid));
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADMAILEDITEMS,     "SELECT mail_id, item_guid, item_template FROM mail_items WHERE receiver = '%u'", GUID_LOPART(m_guid));
    return res;
}
